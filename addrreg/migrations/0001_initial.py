# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-05-16 12:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sumiffiik', addrreg.models.base.SumiffiikIDField(db_index=True, default=uuid.uuid4, unique=True, verbose_name='Sumiffiik ID')),
        ...
        migrations.AlterUniqueTogether(
            name='postalcoderegistrations',
            unique_together=set([('code', 'objectID'), ('id', 'objectID'), ('sumiffiik', 'objectID')]),
        ),
        migrations.AlterIndexTogether(
            name='postalcoderegistrations',
            index_together=set([('objectID', 'registration_from', 'registration_to'), ('object', 'registration_from', 'registration_to')]),
